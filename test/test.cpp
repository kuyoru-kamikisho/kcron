...
int main()
{
	...
	auto result7 = parseTimeString("c 1 3 - - - 12 -", 3);
	auto result8 = parseTimeString("c - - - - 2 - 70", 3);
	auto result9 = parseTimeString("c - - 45 - - - -", 3);

	auto result10 = parseTimeString("z - 1 1 - 0 0 0", 3);
	auto result11 = parseTimeString("z - - - - 1 0 0", 3);
	auto result12 = parseTimeString("z - - 4 3 - 0 0", 3);
	auto result13 = parseTimeString("z - - + - 0 0 0", 13);
	auto result14 = parseTimeString("z - - - 4 14 32 0", 3);
	auto result15 = parseTimeString("z - - - - - - 1", 3);
	auto result16 = parseTimeString("z - - - 1 0 0 0", 3);
	auto result17 = parseTimeString("z - - 1 - 0 0 0", 3);
	auto result18 = parseTimeString("z 2024 1 1 - 0 0 0", 3);
